...
export const SystemMenuItems = (
    <>
        <DropdownItem tag={Link} to="/laboratory/manage">
            <FontAwesomeIcon icon="wrench" fixedWidth /> 实验室管理
        </DropdownItem>
        <DropdownItem tag={Link} to="/laboratory/schedule">
            <FontAwesomeIcon icon="wrench" fixedWidth /> 实验课表管理
        </DropdownItem>
        <DropdownItem tag={Link} to="/experiment/report">
            <FontAwesomeIcon icon="wrench" fixedWidth /> 实验报告管理
        </DropdownItem>
        <DropdownItem tag={Link} to="/experiment/grade">
            <FontAwesomeIcon icon="wrench" fixedWidth /> 实验成绩管理
        </DropdownItem>
        <DropdownItem tag={Link} to="/laboratory/equipment">
            <FontAwesomeIcon icon="wrench" fixedWidth /> 实验设备管理
        </DropdownItem>
        <DropdownItem tag={Link} to="/teacher">
